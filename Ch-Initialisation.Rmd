...
Before we can start analysing the food poisonings, some groundwork is needed to prepare the environment for the analysis, and actually import the data as well.
...
library(FactoMineR) # This includes our dataset along with a lot of factor analysis stuff
